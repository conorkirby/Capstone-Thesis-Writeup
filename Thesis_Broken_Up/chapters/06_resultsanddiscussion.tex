...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/bubblepathwithmean.png}
...
To investigate this scaling further, more $\Delta t$ distributions were added along with more CCDF cuts in an attempt to fit a function to these scaling properties. \textit{See appendix: figure \ref{fig:apdx_ccdfscaling}ß}\\
